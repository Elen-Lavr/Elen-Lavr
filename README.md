...
💪 Моя сильная сторона — не только во владении инструментами анализа (Python, Pandas, SQL, визуализация), но и в любопытстве, которое движет мной в поиске причин, следствий и скрытых закономерностей. Я постоянно совершенствую свои Skills, чтобы минимизировать скрытые риски.
