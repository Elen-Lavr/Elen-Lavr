...
#### Python и библиотеки для анализа:
  -  [Анализ данных о сотрудниках для выявления ключевых факторов, влияющих на увольнение. Проект включает в себя очистку данных, исследовательский анализ (EDA) и подготовку презентации для стейкхолдеров с рекомендациями по снижению текучести.] (https://github.com/Elen-Lavr/employee-turnover-analysis/settings)
