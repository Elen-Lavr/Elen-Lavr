...
#### SQL и поиск данных:
  ...
  - [Анализ данных SQL Pro](https://github.com/Elen-Lavr/Data-Analysis-SQL-Pro). В рамках проекта проведен комплексный анализ данных о проектах компании с использованием PostgreSQL. Решен ряд бизнес-задач, включая подсчет проектов по годам, анализ возраста сотрудников, расчет премий руководителей, накопительные итоги платежей и рекурсивный анализ организационной структуры. В работе активно применяются оконные функции, CTE, рекурсивные запросы и сложные JOIN'ы, что обеспечивает глубокую аналитику для управленческих решений.
