...
#### Python и библиотеки для анализа:
  -  [Анализ данных о сотрудниках для выявления ключевых факторов, влияющих на увольнение.](https://github.com/Elen-Lavr/employee-turnover-analysis/settings) Проект включает в себя очистку данных, исследовательский анализ (EDA) и подготовку презентации для стейкхолдеров с рекомендациями по снижению текучести.
